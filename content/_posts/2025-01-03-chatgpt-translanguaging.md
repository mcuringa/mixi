...
date:   2025-01-03 12:00:00 -0400
event:
  name: ChatGPT Translanguaging for multilingual learners
  start: 2025-03-25T10:15:00-06:00
  end: 2025-03-25T11:15:00-06:00
  location: >
...
[Dr. Rebecca Curinga from CUNY](https://www.csi.cuny.edu/campus-directory/rebecca-curinga)
to present their research on translanguaging with GPT-3 at AAAL 2025.
...
**Where:**\
[Sheraton Denver Downtown Hotel](https://maps.app.goo.gl/CrTFMe9piYcCVEMq6)\
1550 Court Place\
Denver, CO 80202-5107\
United States

**When:**
Friday, March 25, 2025, 10:15 AM - 11:15 AM [[add to gcal](https://www.google.com/calendar/render?action=TEMPLATE&text={{ page.event.name | uri_escape }}&dates={{ page.event.start | date: "%Y%m%dT%H%M%SZ" }}/{{ page.event.end | date: "%Y%m%dT%H%M%SZ" }}&details={{ page.event.description | uri_escape }}&location={{ page.event.location | uri_escape }}&ctz=America/Denver)]