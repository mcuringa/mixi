...
#DegreeHeader { background-color: #D8E2DC; }
#DegreeHeader h1 { color: #416165; }

#PhD-LS { background-color: #FFE5D9; padding-bottom: 2em;}
...
<section id="STEAM" class="container-fluid">
    <div class="row">
        ...
        <div class="col offset-0 offset-md-5 offset-xl-0 d-flex flex-column justify-content-around">
            ...
            <img class="img-fluid d-block" src="/assets/images/led-board.png" alt="programming an LED board interface with Micro:bit">
            <div>
                <h3 class="">See program details and apply now:</h3>
                <ul class="fs-5">
                    <li><a href="http://catalog.adelphi.edu/preview_program.php?catoid=33&poid=16423">MA STEAM Math Education</a></li>
                    <li><a href="https://catalog.adelphi.edu/preview_program.php?catoid=33&poid=16425">MA STEAM Science Education</a></li>
                    <li><a href="https://catalog.adelphi.edu/preview_program.php?catoid=33&poid=16432">MA STEAM CS Education</a></li>
                    <li><a href="https://catalog.adelphi.edu/preview_program.php?catoid=33&poid=16426">MA STEAM Learning Sciences</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<section id="EDX" class="container-fluid">
    <div class="row">
        <div class="col-md-3 offset-md-2">
            ...
            Master's of Arts in Educational Technology<br>
            100% online<br>
